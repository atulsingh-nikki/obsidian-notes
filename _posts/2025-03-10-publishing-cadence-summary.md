...
**Time investment**: ~35-45 hours of focused reading
**Payoff**: A curated curriculum equivalent to multiple graduate-level courses in CV, HPC, applied mathematics, and modern generative models
...
- [Monthly Rollup](#monthly-rollup)
  ...
  - [March 2025 — 9 posts](#march-2025-9-posts)
  ...
  - [January 2026 — 11 posts](#january-2026-11-posts)
  - [February 2026 — 6 posts](#february-2026-6-posts)
  - [April 2026 — 3 posts](#april-2026-3-posts)
  - [May 2026 — 1 post](#may-2026-1-post)
  - [September 2026 — 8 posts](#september-2026-8-posts)
...
- Mar 15: [Evolution of Optimization: From Equations to Gradients]({{ site.baseurl }}{% link _posts/2025-03-15-evolution-of-optimization-from-equations-to-gradients.md %})
...
- Mar 23: [Linear Algebra Journey: Vector Spaces]({{ site.baseurl }}{% link _posts/2025-03-23-linear-algebra-journey-vector-spaces.md %})
...
- Oct 22: [C++ Reference Types Explained: lvalue, rvalue, and Universal References]({{ site.baseurl }}{% link _posts/2025-10-22-cpp-reference-types-explained.md %})
...
- Jan 18: [Mask Refinement Workflow for Premiere Pro and DaVinci Resolve]({{ site.baseurl }}{% link _posts/2026-01-18-mask-refinement-premiere-resolve.md %})
- Jan 27: [Matrix Determinants: The Leibniz Theorem from First Principles]({{ site.baseurl }}{% link _posts/2026-01-27-matrix-determinants-leibniz-theorem.md %})
- Jan 28: [Signed Volume: Geometric Interpretation of Determinants]({{ site.baseurl }}{% link _posts/2026-01-28-signed-volume-geometric-interpretation.md %})
- Jan 29: [Bijective Functions and Invertibility]({{ site.baseurl }}{% link _posts/2026-01-29-bijective-functions-invertibility.md %})
- Jan 30: [Symmetric Groups from First Principles]({{ site.baseurl }}{% link _posts/2026-01-30-symmetric-groups-first-principles.md %})

### February 2026 — 6 posts
- Feb 02: [Dijkstra's Legacy: Modern ML Uses]({{ site.baseurl }}{% link _posts/2026-02-02-dijkstra-ml-uses.md %})
- Feb 03: [Learning Rate Schedulers: Intuitions and Use Cases]({{ site.baseurl }}{% link _posts/2026-02-03-learning-rate-schedulers-intuitions.md %})
- Feb 13: [Taylor Series Expansion: Intuition and Practical Approximation]({{ site.baseurl }}{% link _posts/2026-02-13-taylor-series-expansion-intuition.md %})
- Feb 13: [What is a Hessian Matrix?]({{ site.baseurl }}{% link _posts/2026-02-13-what-is-a-hessian-matrix.md %})
- Feb 14: [Zeroing Model Weights and Differentiability: What's Really Happening?]({{ site.baseurl }}{% link _posts/2026-02-14-zeroing-model-weights-differentiability.md %})
- Feb 14: [Hollywood Color Pipeline: Dailies, DI Show LUTs, and Deliverables]({{ site.baseurl }}{% link _posts/2026-02-14-hollywood-color-pipeline-dailies-di-show-lut.md %})

### April 2026 — 3 posts
- Apr 03: [Beta Distribution: A Short Primer]({{ site.baseurl }}{% link _posts/2026-04-03-beta-distribution-primer.md %})
- Apr 04: [Compressed Uncertainty: Beta Intuition Without the Formula Sheet]({{ site.baseurl }}{% link _posts/2026-04-04-beta-distribution-intuition-compressed-parameterization.md %})
- Apr 05: [Bayesian Inference: A Short Primer]({{ site.baseurl }}{% link _posts/2026-04-05-bayesian-inference-short-primer.md %})

### May 2026 — 1 post
- May 30: [Demystifying Simulation: Why We Let Algorithms Play Dice]({{ site.baseurl }}{% link _posts/2026-05-30-demystifying-simulation-random-variables.md %})

### September 2026 — 8 posts
- Sep 17: [What Is a Linear Probe? A Practical Guide to Probing Classifiers]({{ site.baseurl }}{% link _posts/2026-09-17-what-is-a-linear-probe.md %})
- Sep 17: [Decodability Is Not Disentanglement: Testing for Factorized Representations]({{ site.baseurl }}{% link _posts/2026-09-17-disentanglement-vs-decodability-factorized-testing.md %})
- Sep 17: [Representation Intervention: Proving a Direction Is Causal, Not Just Correlational]({{ site.baseurl }}{% link _posts/2026-09-17-representation-intervention-activation-patching.md %})
- Sep 17: [When There's No Single Direction: Subspaces, Distributed Codes, and a Ladder of Evidence]({{ site.baseurl }}{% link _posts/2026-09-17-single-direction-vs-subspace-representations.md %})
- Sep 19: [DINO: Self-Distillation With No Labels for Vision Transformers]({{ site.baseurl }}{% link _posts/2026-09-19-dino-self-distillation-no-labels-vision-transformers.md %})
- Sep 19: [The Momentum Encoder: Why EMA Teachers Work in Self-Supervised Learning]({{ site.baseurl }}{% link _posts/2026-09-19-momentum-encoder-why-ema-teachers-work.md %})
- Sep 19: [What Does a Vision Transformer Actually Output? Patches, Positions, and the \[CLS\] Token]({{ site.baseurl }}{% link _posts/2026-09-19-vit-patch-embeddings-cls-token-explained.md %})
- Sep 19: [Positional Embeddings in ViT: Why Add Them, and How the Shapes Actually Match]({{ site.baseurl }}{% link _posts/2026-09-19-positional-embeddings-in-vision-transformers.md %})
...
- **2026 Q1 (Jan–Mar)** — 17 posts on variational autoencoders, expected value foundations, depth estimation, image/video matting, determinants, symmetric groups, ML learning-rate tooling, Taylor-series intuition, Hessian matrices, differentiability edge cases, and production color pipelines.
- **2026 Q2 (Apr–Jun)** — 4 posts covering the Beta distribution (formal primer and intuition-first companion), Bayesian inference fundamentals, and simulation/sampling foundations.
- **2026 Q3 (Jul–Sep, so far)** — 8 posts: a 4-part interpretability arc on linear probes, disentanglement vs. decodability, causal activation-patching interventions, and single-direction vs. distributed representations, plus a 4-part self-supervised-ViT cluster on DINO's self-distillation, the momentum-encoder/EMA mechanism it depends on, what a Vision Transformer's patch/`[CLS]` tokens actually output, and how positional embeddings are added.
...
- **2026 H1 (Jan–Jun)** — 21 posts covering variational autoencoders, expected value foundations, depth estimation, image/video matting, determinants, symmetric groups, ML learning-rate tooling, Taylor-series approximation, Hessian matrices, differentiability edge cases, Hollywood color workflow fundamentals, the Beta distribution, and Bayesian inference and simulation foundations.
- **2026 H2 (Jul–Dec, so far)** — 8 posts: the representation-interpretability arc (linear probes, disentanglement, activation patching, single-direction vs. subspace codes) and the self-supervised Vision Transformer cluster (DINO, momentum encoders/EMA teachers, ViT patch/`[CLS]` tokens, positional embeddings).
...
- **2026 (Jan–)** — 29 posts (ongoing): Variational autoencoders, expected value foundations, depth estimation, image/video matting, determinants, symmetric groups, learning-rate scheduler intuition, Taylor-series approximation, Hessian matrices, differentiability edge cases, production color pipeline workflows, the Beta distribution and Bayesian inference, simulation/sampling foundations, a representation-interpretability arc (linear probes, disentanglement, activation patching, distributed codes), and a self-supervised Vision Transformer cluster (DINO, momentum-encoder/EMA teachers, ViT patch/`[CLS]` token mechanics, positional embeddings).
